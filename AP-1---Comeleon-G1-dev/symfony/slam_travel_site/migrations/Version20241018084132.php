 ...
 */
final class Version20241018084132 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contact ADD id INT AUTO_INCREMENT NOT NULL, DROP idcontact, DROP DateContact, DROP PRIMARY KEY, ADD PRIMARY KEY (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contact ADD idcontact INT NOT NULL, ADD DateContact DATETIME NOT NULL, DROP id');
