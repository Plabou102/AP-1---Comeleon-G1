 ...
 */
final class Version20241018082909 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contact ADD id INT AUTO_INCREMENT NOT NULL, DROP idcontact, CHANGE DateContact DateContact DATETIME NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contact ADD idcontact INT NOT NULL, DROP id, CHANGE DateContact DateContact DATETIME NOT NULL');
